...
datautil::StatusCode datautil::floatToTfN(
    ...
    __android_log_print(ANDROID_LOG_ERROR, "QNN ","offset = %d scale = %fnums = %ld\n",offset,scale,numElements);
...
template datautil::StatusCode datautil::castToFloat<float>(float* out,
                                                             float* in,
                                                             size_t numElements);
...
template datautil::StatusCode datautil::castFromFloat<float>(float* out,
                                                               float* in,
                                                               size_t numElements);